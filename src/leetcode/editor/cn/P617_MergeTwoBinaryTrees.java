...
class P617_MergeTwoBinaryTrees_{
    public static void main(String[] args) {
        //测试代码
        Solution solution = new P617_MergeTwoBinaryTrees_().new Solution();
        Integer[] tree1=new Integer[]{1,3,2,5};
        Integer[] tree2=new Integer[]{2,1,3,null,4,null,7,8,null,null,9,null,8};
        TreeNode t1 = new createTreeNode().create(tree1);
        TreeNode t2 = new createTreeNode().create(tree2);
